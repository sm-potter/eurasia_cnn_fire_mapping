...
testing_names = training_names2 + validation_names2 + testing_names2
...
# training_names = get_good(training_names, good_frame)
# validation_names = get_good(validation_names, good_frame)
# testing_names = get_good(testing_names, good_frame)
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_shaped_2015_2019_no_regularize.tf",
#     verbose=1,
...
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_2015_2019_no_regularize.tf")
...
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/russia_good_2015_2019_no_regularize.csv")
