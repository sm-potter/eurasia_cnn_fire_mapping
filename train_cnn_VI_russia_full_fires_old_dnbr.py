...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_no_regularize_old_dnbr",
#     verbose=1,
...
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_no_regularize_old_dnbr.tf")
...
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/russia_good_no_regularize_old_dnbr.csv")
