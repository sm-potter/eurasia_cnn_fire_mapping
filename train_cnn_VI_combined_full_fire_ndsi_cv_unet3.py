...
validation_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_ndsi_composites_training_files.csv')['Files'].tolist()
testing_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_ndsi_composites_training_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath=f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_ndsi_unet3_{fold}",
#     verbose=1,
...
model_unet_from_scratch.save(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_ndsi_unet3_{fold}.tf")
...
result.to_csv(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/combined_good_ndsi_unet3_{fold}.csv")
