...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_net3",
#     verbose=1,
...
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_unet3.tf")
...
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/combined_good_net3.csv")
