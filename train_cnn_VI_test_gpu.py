...
training_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/nbac_training_files.csv')['Files'].tolist()
validation_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/nbac_validation_files.csv')['Files'].tolist()
testing_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/Russia/nbac_testing_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/nbac_mtbs_shaped.tf",
#     verbose=1,
...
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/nbac_mtbs_shaped.tf")
...
# result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/nbac_mtbs.csv")
