...
chunked =  os.listdir('/explore/nobackup/people/spotter5/cnn_mapping/Russia/anna_old_subs_0_128')
...
training_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/mtbs_old_training_files.csv')['Files'].tolist()
validation_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/mtbs_old_validation_files.csv')['Files'].tolist()
testing_names2 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/mtbs_old_testing_files.csv')['Files'].tolist()

training_names3 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_old_training_files.csv')['Files'].tolist()
validation_names3 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_old_validation_files.csv')['Files'].tolist()
testing_names3 = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_old_testing_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath=f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_{fold}_old",
#     verbose=1,
...
model_unet_from_scratch.save(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/combined_good_{fold}_old.tf")
...
result.to_csv(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/combined_good_{fold}_old.csv")
