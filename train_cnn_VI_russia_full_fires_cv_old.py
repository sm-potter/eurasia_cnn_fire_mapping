...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath=f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_no_regularize_{fold}_old",
#     verbose=1,
...
model_unet_from_scratch.save(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/russia_good_no_regularize_{fold}_old.tf")
...
result.to_csv(f"/explore/nobackup/people/spotter5/cnn_mapping/Russia/russia_good_no_regularize_{fold}_old.csv")
