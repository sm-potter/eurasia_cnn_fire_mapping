...
training_names = training_names + training_names2 + testing_names + testing_names2
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/nbac_mtbs_2015_2019.tf",
#     verbose=1,
...
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/Russia/models/nbac_mtbs_2015_2019.tf")
...
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/Russia/nbac_mtbs_2015_2019.csv")
